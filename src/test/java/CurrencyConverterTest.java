...
public class CurrencyConverterTest {
    ...
    public void testGBPtoINR() {
        float initial = 2832.69f;
        float expected = 270549.70f;
    ...
    public void testINRtoCAD() {
        float initial = 270549.70f;
        float expected = 4286.34f;
    ...
    public void testSGDtoCHF() {
        float initial = 4643.53f;
        float expected = 3279.70f;
    ...
    public void testMYRtoJPY() {
        float initial = 14515.12f;
        float expected = 376159.12f;
    ...
    public void testJPYtoCNH() {
        float initial = 376159.12f;
        float expected = 22470.83f;
