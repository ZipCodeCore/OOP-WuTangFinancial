...
public class IndianRupeeTest {
    ...
    @Test
    public void indianRupeeToAmericanDollarTest(){
        IndianRupee indianRupee = new IndianRupee();

        double expected = 3211.04;
        double actual = indianRupee.indianRupeeToAmericanDollar(47);

        Assert.assertEquals("This should return 3211.04", expected, actual, .01);
    }

    @Test
    public void indianRupeeToEuroTest(){
        IndianRupee indianRupee = new IndianRupee();

        double expected = 6105.12;
        double actual = indianRupee.indianRupeeToEuro(84);

        Assert.assertEquals("This should return 6105.12", expected, actual, .01);
    }

    @Test
    public void indianRupeeToBritishPoundTest(){
        IndianRupee indianRupee = new IndianRupee();

        double expected = 4332.12;
        double actual = indianRupee.indianRupeeToBritishPound(52);

        Assert.assertEquals("This should return 4332.12", expected, actual, .01);
    }
}
